...
Beispiel:
    py -3 scripts/erstelle_auswertung.py VM-Daten_17092026.VMZ
"""
...
def create_report(source, output, year):
    ...
    lines = [
        ...
        '',
        f'{"Platz":>5}  {"ID":>4}  {"Name":<30}  {"Serien":>6}  {"Schnitt":>10}  {"Punkte":>8}',
    ]
    for place, (nr, count, points, average, name) in enumerate(ranking, 1):
        lines.append(f'{place:>5}.  {nr:>4}  {name:<30}  {count:>6}  '
...
def main():
    ...
    output = args.output or PROCESS / 'output' / f'Auswertung_{args.year}.txt'
